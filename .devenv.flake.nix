{
  ...
  version = "1.11.1";
  system = "x86_64-linux";
  devenv_root = "/home/caleb/git/saalfeld/paintera";
  project_input_ref = "path:/home/caleb/git/saalfeld/paintera";
  devenv_dotfile = "/home/caleb/git/saalfeld/paintera/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-408efe0";
  ...
  hostname = "cmdesktop";
  username = "caleb";
  git_root = "/home/caleb/git/saalfeld/paintera";
  secretspec = null;
};
    in
    {
